...
void webots_physics_init() {
  ...
  frontRightWheelBody = dWebotsGetBodyFromDEF("TFRW");

  if (frontRightWheelBody == NULL)
    dWebotsConsolePrintf("!!! tractor_physics :: webots_physics_init :: error : could not get frontRightWheelBody.\r\n");
  else {
    dWebotsConsolePrintf("frontRightWheelBody found !\r\n");
  }

  frontLeftWheelBody = dWebotsGetBodyFromDEF("TFLW");

  if (frontLeftWheelBody == NULL)
    dWebotsConsolePrintf("!!! tractor_physics :: webots_physics_init :: error : could not get frontLeftWheelBody.\r\n");
  else {
    dWebotsConsolePrintf("frontLeftWheelBody found !\r\n");
  }
  
  rearRightWheelBody = dWebotsGetBodyFromDEF("TRRW");

  if (rearRightWheelBody == NULL)
    dWebotsConsolePrintf("!!! tractor_physics :: webots_physics_init :: error : could not get rearRightWheelBody.\r\n");
  else {
    dWebotsConsolePrintf("rearRightWheelBody found !\r\n");
  }
  
  rearLeftWheelBody = dWebotsGetBodyFromDEF("TRLW");

  if (rearLeftWheelBody == NULL)
    dWebotsConsolePrintf("!!! tractor_physics :: webots_physics_init :: error : could not get rearLeftWheelBody.\r\n");
  else {
    dWebotsConsolePrintf("rearLeftWheelBody found !\r\n");
  }
}
